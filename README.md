...
Yazılım geliştirme ve bilgisayar bilimlerine tutkuyla bağlı bir geliştiriciyim.  
Uzmanlık alanım **C# programlama dili** olup masaüstü, web ve mobil uygulamalar geliştirmekteyim.

🔹 Flutter ile Android & iOS uygulamalar geliştiriyorum  
🔹 Assembly ve C dili ile hobi olarak geliştirdiğim bir işletim sistemi projem var  
🔹 Sistem programlama alanına özel ilgi duyuyorum  
🔹 Temel Python ve Robotik Kodlama dersleri veriyorum  
🔹 Rust diline yeni giriş yaptım  

Bu GitHub hesabında;

🎯 Hobi projeleri  
🎓 Eğitim içerikleri  
🧪 Deneysel yazılım çalışmaları  
...
<a href="https://mustafakural.com.tr" target="_blank">
...
⭐ Yazılım; öğrenmenin, üretmenin ve paylaşmanın en güçlü yollarından biridir.
